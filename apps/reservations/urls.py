...
urlpatterns = [
    ...
    path('show_reserves/<str:username>/date/<str:date>', views.filtered_reserves_date, name='filtered_reserves_date'),
    ...
    path('filter_date/<str:username>/', views.filter_date, name='filter_date'),
